...
if [[ $stack == "devstack" ]]; then # Install devstack
    ...
    curl -fOL# https://raw.githubusercontent.com/miptliot/edx-configuration/${OPENEDX_RELEASE}/vagrant/release/devstack/Vagrantfile
    ...
    curl -fOL# https://raw.githubusercontent.com/miptliot/edx-configuration/${OPENEDX_RELEASE}/vagrant/release/fullstack/Vagrantfile
